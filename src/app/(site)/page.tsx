  ...
  return (
    <>
        ...
        <section className='px-4 sm:px-6 flex justify-center items-center flex-col relative'>
            <div className="w-[30%] blur-[120px] rounded-full h-32 absolute bg-brand-primary-purple/50 -z-10 
            top-22"/>
            <TitleSection 
            ...
            border-opacity-10 border-washed-purple-300'>
        ...
        <section className='relative'>
            ...
            <div className="mt-20 px-4 sm:px-6 flex flex-col overflow-x-hidden overflow-visible">
                <TitleSection 
                    ...
                    subheading='Join thousands of staisfied users who are using Bsamaritan to increase their personal and professsional productivity needs'
                    pill='Testimonials'/>
                {[...Array(2)].map((arr,index)=>(
                    <div key={randomUUID()} className={twMerge(clsx(
                    ...
                    {USERS.map((testimonial,index)=>(
                        <CustomCard key={testimonial.name} className='w-[500px] shrink-0 rounded-xl dark:bg-gradient-to-t
                        dark:from-border dark:to-border' 
                        cardHeader={
        ...
        <section className='mt-20 px-4 sm:px-6 '>
            ...
            <div className='flex flex-col-reverse sm:flex-row gap-4 justify-center sm:items-stretch items-center mt-10'>
                {PRICING_CARDS.map((card)=>(
                    <CustomCard key={card.planType} className={clsx(
                        ...
                        <CardTitle className='text-2xl font-semibold'>
                            ...
                            <div className='hidden dark:block w-full blur-[120px] rounded-full h-32 absolute
                             bg-brand-primary-purple/80 -z-10 top-0'>
