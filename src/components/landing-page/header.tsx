    ...
    <header className='p-4 flex justify-center items-center'>
        ...
        <NavigationMenu className='hidden md:block'>
            <NavigationMenuList className='gap-6'>
                <NavigationMenuItem>
                    ...
                    className={cn({'dark:tesxt-white': path==='#resources','dark:text-white' : path!='#resources','font-normal':true,'text-xl':true,})}>
                        Resources
                    </NavigationMenuTrigger>
                    <NavigationMenuContent>
                        <ul className='gird gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]'>
        ...
        <aside className='flex w-full gap-2 justify-end'>
            ...
            <Link href={'/signup'} className='text-white'>
                <Button variant='btn-primary' className='p-1 hidden sm:block'>Signup</Button>
            </Link>
        </aside>
    </header>
  )
